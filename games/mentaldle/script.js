Wordle = new function() {
        ...
        this.Game = function(options) {
            ...
            this.getShareText = function(message) {
                message = message || 'Mentaldle ' + (this.row) + '/' + options.rows;
                var share = [message, ''];
                ...
                if (this.answer == attemptWord) {
                    switch (this.row + 1) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            var tries = 'three tries!';
                            break;
                        case 4:
                            var tries = 'four tries.';
                            break;
                        case 5:
                            var tries = 'five tries.';
                            break;
                        case 6:
                            var tries = 'six tries.';
                            break;
                        case 7:
                            var tries = 'seven tries.';
                            break;
                        case 8:
                            var tries = 'eight tries.';
                            break;
                        case 9:
                            var tries = 'nine tries.';
                            break;
                        case 10:
                            var tries = 'ten tries.';
                            break;
...
var dictURL = '/games/mentaldle/words.txt';
